    ...
    */
    ...
    public:
        ...
        */
        ...
        // CHANGED
        inline void encrypt_bfv(const Plaintext &plain, Ciphertext &destination,
             MemoryPoolHandle pool = MemoryManager::GetPool()) const
        {
            encrypt_internal_bfv(plain, true, false, destination, pool);
        }
        
        // CHANGED
        inline void encrypt_bfv(const std::vector<int> &plain, Ciphertext &destination,
                                MemoryPoolHandle pool = MemoryManager::GetPool()) const
        {
            encrypt_internal_bfv(plain, true, false, destination, pool);
        }
        ...
        // CHANGED
        inline void encrypt_ckks(const std::vector<int> &plain, long nshift, Ciphertext &destination,
                                 MemoryPoolHandle pool = MemoryManager::GetPool()) const
        {
            encrypt_internal_ckks(plain, nshift, true, false, destination, pool);
        }
    ...
    private:
        ...
        // CHANGED
        void encrypt_zero_internal_fast(
                                   parms_id_type parms_id,
                                   bool is_asymmetric, bool save_seed,
                                   Ciphertext &destination,
                                   MemoryPoolHandle pool = MemoryManager::GetPool()) const;
        // CHANGED
        void encrypt_internal_bfv(
            const Plaintext &plain,
            bool is_asymmetric, bool save_seed,
            Ciphertext &destination,
            MemoryPoolHandle pool = MemoryManager::GetPool()) const;
        ...
        // CHANGED
        void encrypt_internal_ckks(
            const std::vector<int> &plain, long nshift,
            bool is_asymmetric, bool save_seed,
            Ciphertext &destination,
            MemoryPoolHandle pool = MemoryManager::GetPool()) const;
